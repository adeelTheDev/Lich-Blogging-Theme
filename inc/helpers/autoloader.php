...
function autoloader($resource = '') {
  ...
  if ('inc' === $path[0]) {
    ...
    $resource_path = sprintf('%s/inc/%s/%s.php', untrailingslashit(LICH_DIR_PATH), $directory, $file_name);
  }
...
spl_autoload_register('\LICH\Inc\Helpers\autoloader');
